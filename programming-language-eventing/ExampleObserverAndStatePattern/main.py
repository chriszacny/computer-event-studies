...
EVENT_HANDLER_PRE = 'STATE CHANGE EVENT HANDLER: '
...
class UIStateChangeNotifier(EventHandler):
    def handle_event(self, test_run):
        print('{}Simulating sending state change websocket data to UI.'.format(EVENT_HANDLER_PRE))


class MSTeamsStateChangeNotifier(EventHandler):
    def handle_event(self, test_run):
        print('{}Simulating sending state change data to MS Teams.'.format(EVENT_HANDLER_PRE))
